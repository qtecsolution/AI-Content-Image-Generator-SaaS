...
!(function (t) {
    ...
    return (
        x.extend(!0, o.defaults, { 
            ...
            oLanguage: {
                oPaginate: {
                    sPrevious:  `<svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    sNext:` <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        (o.ext.renderer.pageButton.bootstrap = function (d, e, s, a, l, c) {
            ...
            n.length ? n.empty() : (n = e.html("<ul/>").children("ul").addClass(" custom-pagination")), u(n, a), t !== i && e.find("[data-dt-idx=" + t + "]").trigger("focus");
        }),
        o
    );
});
