...
@section('content')
    <div class="main-content p-2 p-md-4 pt-0">
        <form action="{{route('contents.update',$data->id)}}" method="POST" class="createpost-form  needs-validation  h-100 d-flex flex-column  justify-content-between">
            @csrf 
            @method('PUT')
            <div class="row g-4">
                ...
                <div class="col-lg-5 mt-0">
                    ...
                    <div class="create-post">
                        ...
                        <div class="form-content">
                            <h3 class="create-post-header">Edit Content</h3>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control custom-input" id="title" required
                                            autocomplete="off" name="title" placeholder="Write here..." value="{{$data->title}}">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control custom-input" id="keywords" required
                                            autocomplete="off" name="keywords" placeholder="Enter your keywords"  value="{{$data->keywords}}">
                                        <div class="valid-feedback">
                                            Awesome! You're one step closer to greatness.
                                        </div>
                                        <div class="invalid-feedback">
                        ...
                        <div class="generate-btn-wrapper">
                            <button type="submit" class="generate-btn"> <i class="fa fa-save"> </i> &nbsp; Update</button>
                        </div>
