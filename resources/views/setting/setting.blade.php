            ...
            <div class="tab-pane fade show active" id="Papal-tab-pane" role="tabpanel" aria-labelledby="Papal-tab"
                ...
                {{-- <form method="post" action="{{open.ai.store}}"> --}}
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="open_key" value="{{App\Http\Controllers\HomeController::readConfig('open_key')}}" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
