            ...
            <div class="my-projects-body">
                <div class="row g-2  mt-3">
                            ...
                            <div class="p-2">
                                ...
                                @else
                                    <img src="{{ asset('assets/images/placeholder.png') }}"
                                        alt="{{ $user->name }}" style="max-width:150px" class="rounded">
                                @endif
                            </div>
                            <div class="card-body">
                    ...
                    <div class="col-lg-6 border-none border-lg-start">
                        <form method="POST" action="{{ route('profile.password.update') }}" class="authentication-form needs-validation ps-0 ps-lg-2">
                            @csrf
