                    ...
                    <form action="{{ route('payment.paypal.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-2">
                            ...
                            <select class="form-control select2 w-100" name="PAYPAL_ACTIVE">
                                ...
                                <option value="off" {{ readConfig('PAYPAL_ACTIVE') == 'off' ? 'selected' : null }}>Off
                                </option>
                            </select>
                        </div>
                        <div class="form-group mb-2">
                ...
                <form action="{{ route('payment.stripe.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-2">
                        ...
                        <select class="form-control select2 w-100" name="STRIPE_ACTIVE">
                            ...
                            <option value="off" {{ readConfig('STRIPE_ACTIVE') == 'off' ? 'selected' : null }}>Off
                            </option>
                        </select>
                    </div>
                    <div class="form-group mb-2">
                    ...
                    <div class="form-group mb-2">
                        ...
                        <input class="form-control" name="STRIPE_SECRET" value="{{ readConfig('STRIPE_SECRET') }}"
                ...
                <form action="{{ route('payment.rezor.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-2">
                        ...
                        <select class="form-control select2 w-100" name="RAZORPAY_ACTIVE">
                            <option value="on" {{ readConfig('RAZORPAY_ACTIVE') == 'on' ? 'selected' : null }}>ON
                            </option>
                            <option value="off" {{ readConfig('RAZORPAY_ACTIVE') == 'off' ? 'selected' : null }}>Off
                            </option>
                        </select>
                    </div>
                    <div class="form-group mb-2">
                    ...
                    <div class="form-group mb-2">
                        ...
                        <input class="form-control" name="RAZORPAY_SECRET" value="{{ readConfig('RAZORPAY_SECRET') }}"
                ...
                <form action="{{ route('payment.mollie.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-2">
                        ...
                        <select class="form-control select2 w-100" name="MOLLIE_ACTIVE">
                            <option value="on" {{ readConfig('MOLLIE_ACTIVE') == 'on' ? 'selected' : null }}>ON
                            </option>
                            <option value="off" {{ readConfig('MOLLIE_ACTIVE') == 'off' ? 'selected' : null }}>Off
                            </option>
                        </select>
                    </div>
                    <div class="form-group mb-2">
                    ...
                    <div class="form-group mb-2">
                        ...
                        <input class="form-control" name="MOLLIE_Partner_ID" value="{{ readConfig('MOLLIE_Partner_ID') }}"
                    ...
                    <div class="form-group mb-2">
                        ...
                        <input class="form-control" name="MOLLIE_Profile_ID" value="{{ readConfig('MOLLIE_Profile_ID') }}"
