...
>>>>>>> origin/kawsar
                ...
                <a href="#" class="dashboard-link gray-800 d-flex align-items-center fz-14">
                    <span class="icon">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="menu-accordion">
                    <div class="accordion" id="userMenuAccordion">
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="headingThree">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                    data-bs-target="#aiImages" aria-expanded="false" aria-controls="collapseThree">
                                    <span class="icon">
                                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                            ...
                            <div id="aiImages" class="accordion-collapse collapse " aria-labelledby="headingThree"
                                data-bs-parent="#userMenuAccordion">
                                <div class="accordion-body">
                                    <div class="menu-items">
