                                        ...
                                        <span class="icon">
                                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                                ...
                                                <path
                                                    ...
                                                    stroke="#475467" stroke-width="2" stroke-linecap="round"
                                                    stroke-linejoin="round"/>
                                                <path d="M2.5 7.5H17.5" stroke="#475467" stroke-width="2"
                                                      stroke-linecap="round"
                                                      stroke-linejoin="round"/>
                                                <path d="M7.5 17.5V7.5" stroke="#475467" stroke-width="2"
                                                      stroke-linecap="round"
                                                      stroke-linejoin="round"/>
                                            </svg>
                                        </span>
                                                ...
                                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                                    ...
                                                    <g clip-path="url(#clip0_532_26203)">
                                                        ...
                                                        <path d="M12.5 7.5H7.5V12.5H12.5V7.5Z" stroke="#475467"
                                                              ...
                                                              stroke-linejoin="round"/>
                                                        <path d="M7.5 0.833344V3.33334" stroke="#475467"
                                                              stroke-width="2"
                                                              stroke-linecap="round" stroke-linejoin="round"/>
                                                        <path d="M12.5 0.833344V3.33334" stroke="#475467"
                                                              stroke-width="2"
                                                              stroke-linecap="round" stroke-linejoin="round"/>
                                                        <path d="M7.5 16.6667V19.1667" stroke="#475467" stroke-width="2"
                                                              stroke-linecap="round" stroke-linejoin="round"/>
                                                        <path d="M12.5 16.6667V19.1667" stroke="#475467"
                                                              stroke-width="2"
                                                              stroke-linecap="round" stroke-linejoin="round"/>
                                                        <path d="M16.6665 7.5H19.1665" stroke="#475467" stroke-width="2"
                                                              stroke-linecap="round" stroke-linejoin="round"/>
                                                        <path d="M16.6665 11.6667H19.1665" stroke="#475467"
                                                              stroke-width="2"
                                                              stroke-linecap="round" stroke-linejoin="round"/>
                                                        <path d="M0.833496 7.5H3.3335" stroke="#475467" stroke-width="2"
                                                              stroke-linecap="round" stroke-linejoin="round"/>
                                                        <path d="M0.833496 11.6667H3.3335" stroke="#475467"
                                                              stroke-width="2"
                                                              stroke-linecap="round" stroke-linejoin="round"/>
                                                    </g>
                                                    <defs>
                                                    ...
                                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                                        ...
                                                        <g clip-path="url(#clip0_532_26228)">
                                                            <path
                                                                ...
                                                                stroke="#475467" stroke-width="2" stroke-linecap="round"
                                                                stroke-linejoin="round"/>
                                                            <path d="M0.833496 8.33334H19.1668" stroke="#475467"
                                                                  stroke-width="2"
                                                                  stroke-linecap="round" stroke-linejoin="round"/>
                                                        </g>
                                                        <defs>
                                    ...
                                    <div class="accordion-body">
                                        <div class="menu-items">
                                            ...
                                            <a href="{{ route('blog-category.index') }}"
                                               class="menu-item {{ menuActive('blog-category.*') ? 'active' : '' }}">Blog
                                                Category</a>
                                            <a href="{{ route('manage-faq.index') }}"
                                               class="menu-item {{ menuActive('manage-faq.*') ? 'active' : '' }}">FAQ
                                                Manager</a>
                                        ...
                                        <div class="menu-items">
                                            <a href="{{ route('setting') }}?tab=cms"
                                               class="menu-item {{ menuActive('setting') && request()->input('tab') == 'cms' ? 'active' : '' }}">General
                                                Settings</a>
                                            <a href="{{ route('setting') }}?tab=smtp"
                                               class="menu-item {{ menuActive('setting') && request()->input('tab') == 'smtp' ? 'active' : '' }}">Mail
                                                Configure</a>
                                            <a href="{{ route('setting') }}?tab=seo"
                                               class="menu-item {{ menuActive('setting') && request()->input('tab') == 'seo' ? 'active' : '' }}">SEO
                                                Settings</a>
                                            <a href="{{ route('setting') }}?tab=login"
                                               class="menu-item {{ menuActive('setting') && request()->input('tab') == 'login' ? 'active' : '' }}">Social
                                                Login</a>
                                            <a href="{{ route('setting') }}?tab=tawkto"
                                               class="menu-item {{ menuActive('setting') && request()->input('tab') == 'tawkto' ? 'active' : '' }}">Tawk
                                                (Live chat)</a>
                                            <a href="{{ route('setting') }}?tab=pwa"
                ...
                <li class="headermenu-item">
                    ...
                    <div class="userdropdown">
                        ...
                        <ul class="userlist">
                            ...
                            <li class="userlist-item">
                                <a href="{{ route('profile.password') }}" class="userlist-link">Change
                                    Password</a>
                            </li>
                            <li class="userlist-item">
                        ...
                        @if(Auth::user()->type=='admin')
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header">
                                    <button
                                        class="accordion-button {{menuActive(['users.*','admin.*'])?'':'collapsed'}}"
                                        type="button" data-bs-toggle="collapse" data-bs-target="#manage-user-mobile"
                                        aria-expanded="false" aria-controls="manage-user-mobile">
                                            <span class="icon">
                                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                                     xmlns="http://www.w3.org/2000/svg">
                                                    <g clip-path="url(#clip0_532_26219)">
