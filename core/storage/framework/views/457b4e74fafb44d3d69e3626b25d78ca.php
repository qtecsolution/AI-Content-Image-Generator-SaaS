                ...
                <div class="col-12">
                    <ul class="nav nav-tabs setting-tab" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link <?php if(isset($tab) && $tab == 'openai'): ?> active <?php endif; ?>" id="Papal-tab"
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link <?php if(isset($tab) && $tab == 'tawkto'): ?> active <?php endif; ?>" id="Stripe-tab"
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link <?php if(isset($tab) && $tab == 'login'): ?> active <?php endif; ?>" id="social-tab"
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link <?php if(isset($tab) && $tab == 'seo'): ?> active <?php endif; ?>" id="seo-tab"
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link <?php if(isset($tab) && $tab == 'smtp'): ?> active <?php endif; ?>" id="RazorPay-tab"
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link <?php if(isset($tab) && $tab == 'cms'): ?> active <?php endif; ?>" id="FlutterWave-tab"
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link <?php if(isset($tab) && $tab == 'pwa'): ?> active <?php endif; ?>" id="pwa-tab"
                    ...
                    <div class="tab-content mt-5 setting-tab-content" id="myTabContent">
                        <div class="tab-pane fade <?php if(isset($tab) && $tab == 'openai'): ?> show active <?php endif; ?>" id="Papal-tab-pane"
                            role="tabpanel" aria-labelledby="Papal-tab" tabindex="0">

                            <div class="row">
                                <div class="col-lg-7">
                                    <form method="post" action="<?php echo e(route('open.ai.store')); ?>">
                                        <?php echo csrf_field(); ?>
                                        <div class="form-group mb-3">
                                            <label for="exampleInputEmail1" class="form-label">OpenAi Api Key</label>
                                            <input type="text" name="OPENAI_API_KEY" value="<?php echo e(env('OPENAI_API_KEY')); ?>"
                        ...
                        <div class="tab-pane fade <?php if(isset($tab) && $tab == 'tawkto'): ?> show active <?php endif; ?>" id="Stripe-tab-pane"
                            role="tabpanel" aria-labelledby="Stripe-tab" tabindex="0">

                            <div class="row">
                                <div class="col-md-7">
                                    <form method="post" action="<?php echo e(route('tawkto.store')); ?>">
                                        <?php echo csrf_field(); ?>
                                        <div class="form-group mb-3">
                                            ...
                                            <select class="form-control custom-input" name="tawk_to" required>
                                                <option value="no"
                                                    <?php echo e(readConfig('tawk_to') == 'no' ? 'selected' : null); ?>>NO</option>
                                                <option value="yes"
                                                    <?php echo e(readConfig('tawk_to') == 'yes' ? 'selected' : null); ?>>YES</option>
                                            </select>
                                        ...
                                        <div class="form-group mb-3">
                                            <label for="exampleInputPassword1" class="form-label">Place where the Tawk to
                                                script</label>
                                            <textarea class="form-control custom-input" name="code" rows="14"><?php echo $__env->make('layouts.tawk_to', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>;</textarea>
                        ...
                        <div class="tab-pane fade <?php if(isset($tab) && $tab == 'login'): ?> show active <?php endif; ?>"
                            id="social-tab-pane" role="tabpanel" aria-labelledby="social-tab" tabindex="0">

                            <div class="row">
                                <div class="col-lg-7">
                                    <form class="project-table-wrapper p-3" method="post" action="<?php echo e(route('social.store')); ?>">
                                        <?php echo csrf_field(); ?>
                                        <div class="form-group mb-3">
                                            <label for="exampleInputEmail1" class="form-label">Google Client Id</label>
                                            <input type="text" class="form-control custom-input"
                                                value="<?php echo e(env('GOOGLE_CLIENT_ID')); ?>" id="exampleInputEmail1"
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control custom-input"
                                                value="<?php echo e(env('GOOGLE_CLIENT_SECRET')); ?>" id="exampleInputEmail1"
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control custom-input"
                                                value="<?php echo e(route('auth.google.callback')); ?>" id="exampleInputEmail1"
                        ...
                        <div class="tab-pane fade <?php if(isset($tab) && $tab == 'seo'): ?> show active <?php endif; ?>" id="seo-tab-pane"
                            role="tabpanel" aria-labelledby="seo-tab" tabindex="0">

                            <div class="row">
                                <div class="col-lg-7">
                                    <form class="project-table-wrapper p-3" method="post"
                                        action="<?php echo e(route('seo.store')); ?>" enctype="multipart/form-data">
                                        <?php echo csrf_field(); ?>
                                        <div class="form-group mb-3">
                                            <label for="exampleInputEmail1" class="form-label">Meta Key</label>
                                            <input type="text" class="form-control custom-input"
                                                value="<?php echo e(readConfig('meta_key')); ?>" id="exampleInputEmail1"
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control custom-input"
                                                value="<?php echo e(readConfig('meta_title')); ?>" id="exampleInputEmail1"
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control custom-input"
                                                value="<?php echo e(readConfig('meta_desc')); ?>" id="exampleInputEmail1"
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="file" class="form-control custom-input" id="exampleInputEmail1"
                                                ...
                                                <img src="<?php echo e(filePath(readConfig('meta_image'))); ?>" width="100">
                                        </div>
                        ...
                        <div class="tab-pane fade <?php if(isset($tab) && $tab == 'smtp'): ?> show active <?php endif; ?>"
                            id="RazorPay-tab-pane" role="tabpanel" aria-labelledby="RazorPay-tab" tabindex="0">

                            <div class="row">
                                <div class="col-md-7">
                                    <form class="form-horizontal" action="<?php echo e(route('smtp.store')); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
                                        <div class="form-group mb-2 mt-2">
                                            ...
                                            <select class="form-control custom-input" name="MAIL_DRIVER">
                                                <option value="sendmail"
                                                    <?php if(env('MAIL_DRIVER') == 'sendmail'): ?> selected <?php endif; ?>>
                                                    Sendmail
                                                </option>
                                                <option value="smtp" <?php if(env('MAIL_DRIVER') == 'smtp'): ?> selected <?php endif; ?>>
                                                    SMTP
                                                </option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group mb-2">
                                            ...
                                            <div class="">
                                                <input type="text" class="form-control custom-input" name="MAIL_USERNAME"
                                                    value="<?php echo e(env('MAIL_USERNAME')); ?>" required>
                                            </div>
                                        </div>
                                        <div class="form-group mb-2">
                                        ...
                                        <div class="form-group mb-2">
                                            ...
                                            <div class="">
                                                <input type="text" class="form-control custom-input" name="MAIL_FROM_ADDRESS"
                                                    value="<?php echo e(env('MAIL_FROM_ADDRESS')); ?>" required>
                                            </div>
                                        </div>
                                        <div class="form-group mb-2">
                                            ...
                                            <div class="">
                                                <input type="text" class="form-control custom-input" name="MAIL_FROM_NAME"
                                                    value="<?php echo e(env('MAIL_FROM_NAME')); ?>" required>
                                            </div>
                                        </div>
                                        <div class="form-group mb-2">
                        ...
                        <div class="tab-pane fade <?php if(isset($tab) && $tab == 'cms'): ?> show active <?php endif; ?>"
                                    ...
                                    <div class="col-md-4 col-sm-12 mb-2">
                                        ...
                                        <div class="avatar-upload">
                                            ...
                                            <div class="avatar-preview">
                                                <div id="imagePreview"
                                                    style="background-image: url(<?php echo e(filePath(readConfig('type_logo'))); ?>);">
                                                </div>
                                            </div>
                                        </div>
                                        <!--logo end-->
                                        ...
                                        <div class="avatar-upload">
                                            ...
                                            <div class="avatar-preview">
                                                <div id="imagePreview_f_logo"
                                                    style="background-image: url(<?php echo e(filePath(readConfig('footer_logo'))); ?>);">
                                                </div>
                                            </div>
                                        </div>
                                        <!--footer logo end-->
                                        ...
                                        <div class="avatar-upload">
                                            ...
                                            <div class="avatar-preview">
                                                <div id="imagePreview_f_icon"
                                                    style="background-image: url(<?php echo e(filePath(readConfig('favicon_icon'))); ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <!--favicon end-->
                                ...
                                <div class="row">
                                    <div class="col-md-6 ">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" value="<?php echo e(readConfig('type_name')); ?>" name="name"
                                                class="form-control custom-input">
                                        </div>
                                        <div class="mb-3">
                                            <!--footer-->
                                            ...
                                            <input type="text" value="<?php echo e(readConfig('type_footer')); ?>" name="footer"
                                                class="form-control custom-input">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" value="<?php echo e(readConfig('type_address')); ?>"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" value="<?php echo e(readConfig('type_mail')); ?>" name="mail"
                                                class="form-control custom-input">
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" value="<?php echo e(readConfig('type_fb')); ?>" name="fb"
                                                class="form-control custom-input">
                                        </div>
                                        <div class="mb-3">
                                            <!--tw-->
                                            ...
                                            <input type="text" value="<?php echo e(readConfig('type_tw')); ?>" name="tw"
                                                class="form-control custom-input">
                                        </div>
                                        <div class="mb-3">
                                            <!--google-->
                                            ...
                                            <input type="text" value="<?php echo e(readConfig('type_google')); ?>" name="google"
                                                class="form-control custom-input">
                                        </div>
                                        <div class="mb-3">
                                            <!--Number-->
                                            ...
                                            <input type="text" value="<?php echo e(readConfig('type_number')); ?>" name="number"
                                                class="form-control custom-input">
                                        </div>
                        ...
                        <div class="tab-pane fade <?php if(isset($tab) && $tab == 'pwa'): ?> show active <?php endif; ?>"
                            id="pwa-tab-pane" role="tabpanel" aria-labelledby="pwa-tab" tabindex="0">

                            <form method="post" action="<?php echo e(route('pwa.setup.store')); ?>" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group md-2">
                                            <label class="col-form-label">Progressive Web Apps Actives Status <span class="text-danger">*</span></label>
                                            <select name="pwa_active" class="form-control select2" required>
                                                <option value="yes" <?php echo e(readConfig('pwa_active') == 'yes' ? 'selected' : null); ?>>
                                                    On</option>
                                                <option value="off" <?php echo e(readConfig('pwa_active') == 'off' ? 'selected' : null); ?>>
                                                    Off</option>
                                            </select>
                                        </div>
                                        <!--name-->
                                        ...
                                        <!--name-->
                                        <div class="form-group md-2">
                                            <label class="col-form-label">Progressive Web Apps Name</label>
                                            <input class="form-control custom-input" name="pwa_name" type="text"
                                                value="<?php echo e(config('laravelpwa.name')); ?>">
                                        </div>
                
                                        <div class="form-group md-2">
                                            <label class="col-form-label">Progressive Web Apps Short Name</label>
                                            <input class="form-control custom-input" name="short_name" type="text"
                                                value="<?php echo e(config('laravelpwa.manifest.short_name')); ?>">
                                        </div>
                
                
                                        <div class="form-group md-2 ">
                                            <label class="col-form-label">Progressive Web Apps background color</label>
                                            <input class="form-control custom-input" name="background_color" type="color"
                                                value="<?php echo e(config('laravelpwa.manifest.background_color')); ?>">
                                        </div>
                
                                        <div class="form-group md-2">
                                            <label class="col-form-label">Progressive Web Apps theme color</label>
                                            <input class="form-control custom-input" name="theme_color" type="color"
                                                value="<?php echo e(config('laravelpwa.manifest.theme_color')); ?>">
                                        </div>
                
                                        <div class="form-group card p-2 my-2">
                                            <label class="col-form-label">Progressive Web Apps 72x72 Icon</label>
                                            <input class="form-control custom-input" accept="image/png, image/jpeg" name="x72x72_icon" type="file">
                                            <div class="text-center m-2">
                                                <?php echo e(filePathRoot(config('laravelpwa.manifest.icons.72x72.path'))); ?>

                                                <img class="img-fluid" width="72" height="72" src="<?php echo e(filePathRoot(config('laravelpwa.manifest.icons.72x72.path'))); ?>">
                                            </div>
                                        </div>
                
                
                                        <div class="form-group card p-2 my-2">
                                            <label class="col-form-label">Progressive Web Apps 96x96 Icon</label>
                                            <input class="form-control custom-input" accept="image/png, image/jpeg" name="x96x96_icon" type="file">
                                            <div class="text-center m-2">
                                                <img class="img-fluid" width="96" height="96" src="<?php echo e(filePathRoot(config('laravelpwa.manifest.icons.96x96,path'))); ?>">
                                            </div>
                                        </div>
                
                                        <div class="form-group card p-2 my-2">
                                            <label class="col-form-label">Progressive Web Apps 128x128 Icon</label>
                                            <input class="form-control custom-input" accept="image/png, image/jpeg" name="x128x128_icon" type="file">
                                            <div class="text-center m-2">
                                                <img class="img-fluid" width="128" height="128" src="<?php echo e(filePathRoot(config('laravelpwa.manifest.icons.128x128.path'))); ?>">
                                            </div>
                                        </div>
                
                                        <div class="form-group card p-2 my-2">
                                            <label class="col-form-label">Progressive Web Apps 144x144 Icon</label>
                                            <input class="form-control custom-input" accept="image/png, image/jpeg" name="x144x144_icon" type="file">
                                            <div class="text-center m-2">
                                                <img class="img-fluid" width="144" height="144" src="<?php echo e(filePathRoot(config('laravelpwa.manifest.icons.144x144.path'))); ?>">
                                            </div>
                                        </div>
                
                                        <div class="form-group card p-2 my-2">
                                            <label class="col-form-label">Progressive Web Apps 152x152 Icon</label>
                                            <input class="form-control custom-input" accept="image/png, image/jpeg" name="x152x152_icon" type="file">
                                            <div class="text-center m-2">
                                                <img class="img-fluid" width="152" height="152" src="<?php echo e(filePathRoot(config('laravelpwa.manifest.icons.152x152.path'))); ?>">
                                            </div>
                                        </div>
                
                                        <div class="form-group card p-2 my-2">
                                            <label class="col-form-label">Progressive Web Apps 192x192 Icon</label>
                                            <input class="form-control custom-input" accept="image/png, image/jpeg" name="x192x192_icon" type="file">
                                            <div class="text-center m-2">
                                                <img class="img-fluid" width="192" height="192" src="<?php echo e(filePathRoot(config('laravelpwa.manifest.icons.192x192.path'))); ?>">
                                            </div>
                                        </div>
                
                                        <div class="form-group card p-2 my-2">
                                            <label class="col-form-label">Progressive Web Apps 384x384 Icon</label>
                                            <input class="form-control custom-input" accept="image/png, image/jpeg" name="x384x384_icon" type="file">
                                            <div class="text-center m-2">
                                                <img class="img-fluid" width="384" height="384" src="<?php echo e(filePathRoot(config('laravelpwa.manifest.icons.384x384.path'))); ?>">
                                            </div>
                                        </div>
                
                                        <div class="form-group card p-2 my-2">
                                            <label class="col-form-label">Progressive Web Apps 512x512 Icon</label>
                                            <input class="form-control custom-input" accept="image/png, image/jpeg" name="x512x512_icon" type="file">
                                            <div class="text-center m-2">
                                                <img class="img-fluid" width="512" height="512" src="<?php echo e(filePathRoot(config('laravelpwa.manifest.icons.512x512.path'))); ?>">
                                            </div>
                                        </div>
                
                                        <div class="form-group card p-2 my-2">
                                            <label class="col-form-label">Progressive Web Apps 640x1136 Splash Screen</label>
                                            <input class="form-control custom-input" accept="image/png, image/jpeg" name="x640x1136_splash" type="file">
                                            <div class="text-center m-2">
                                                <img class="img-fluid" width="640" height="1136" src="<?php echo e(filePathRoot(config('laravelpwa.manifest.splash.640x1136'))); ?>">
                                            </div>
                                        </div>
                
                                        <div class="form-group card p-2 my-2">
                                            <label class="col-form-label">Progressive Web Apps 750x1334 Splash Screen</label>
                                            <input class="form-control custom-input" accept="image/png, image/jpeg" name="x750x1334_splash" type="file">
                                            <div class="text-center m-2">
                                                <img class="img-fluid" width="750" height="1334" src="<?php echo e(filePathRoot(config('laravelpwa.manifest.splash.750x1334'))); ?>">
                                            </div>
                                        </div>
                
                                        <div class="form-group card p-2 my-2">
                                            <label class="col-form-label">Progressive Web Apps 828x1792 Splash Screen</label>
                                            <input class="form-control custom-input" accept="image/png, image/jpeg" name="x828x1792_splash" type="file">
                                            <div class="text-center m-2">
                                                <img class="img-fluid" width="828" height="1792" src="<?php echo e(filePathRoot(config('laravelpwa.manifest.splash.828x1792'))); ?>">
                                            </div>
                                        </div>
                
                                        <div class="form-group card p-2 my-2">
                                            <label class="col-form-label">Progressive Web Apps 1536x2048 Splash Screen</label>
                                            <input class="form-control custom-input" accept="image/png, image/jpeg" name="x1536x2048_splash" type="file">
                                            
                                            <div class="text-center m-2">
                                                <img class="img-fluid" width="1536" height="2048" src="<?php echo e(filePathRoot(config('laravelpwa.manifest.splash.1536x2048'))); ?>">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group card p-2 my-2">
                                            <label class="col-form-label">Progressive Web Apps 1125x2436 Splash Screen</label>
                                            <input class="form-control custom-input" accept="image/png, image/jpeg" name="x1125x2436_splash" type="file">
                                            <div class="text-center m-2">
                                                <img class="img-fluid" width="1125" height="2436" src="<?php echo e(filePathRoot(config('laravelpwa.manifest.splash.1125x2436'))); ?>">
                                            </div>
                                        </div>
                
                                        <div class="form-group card p-2 my-2">
                                            <label class="col-form-label">Progressive Web Apps 1242x2208 Splash Screen</label>
                                            <input class="form-control custom-input" accept="image/png, image/jpeg" name="x1242x2208_splash" type="file">
                                            <div class="text-center m-2">
                                                <img class="img-fluid" width="1242" height="2208" src="<?php echo e(filePathRoot(config('laravelpwa.manifest.splash.1242x2208'))); ?>">
                                            </div>
                                        </div>
                
                                        <div class="form-group card p-2 my-2">
                                            <label class="col-form-label">Progressive Web Apps 1242x2688_splash Splash Screen</label>
                                            <input class="form-control custom-input" accept="image/png, image/jpeg" name="x1242x2688_splash" type="file">
                                            <div class="text-center m-2">
                                                <img class="img-fluid" width="1242" height="2688" src="<?php echo e(filePathRoot(config('laravelpwa.manifest.splash.1242x2688'))); ?>">
                                            </div>
                                        </div>
                                        <div class="form-group card p-2 my-2">
                                            <label class="col-form-label">Progressive Web Apps 1668x2224 Splash Screen</label>
                                            <input class="form-control custom-input" accept="image/png, image/jpeg" name="x1668x2224_splash" type="file">
                                            <div class="text-center m-2">
                                                <img class="img-fluid" width="1668" height="2224" src="<?php echo e(filePathRoot(config('laravelpwa.manifest.splash.1668x2224'))); ?>">
                                            </div>
                                        </div>
                                        <div class="form-group card p-2 my-2">
                                            <label class="col-form-label">Progressive Web Apps 1668x2388 Splash Screen</label>
                                            <input class="form-control custom-input" accept="image/png, image/jpeg" name="x1668x2388_splash" type="file">
                                            <div class="text-center m-2">
                                                <img class="img-fluid" width="1668" height="2388" src="<?php echo e(filePathRoot(config('laravelpwa.manifest.splash.1668x2388'))); ?>">
                                            </div>
                                        </div>
                                        <div class="form-group card p-2 my-2">
                                            <label class="col-form-label">Progressive Web Apps 2048x2732 Splash Screen</label>
                                            <input class="form-control custom-input" accept="image/png, image/jpeg" name="x2048x2732_splash" type="file">
                                            <div class="text-center m-2">
                                                <img class="img-fluid" width="2048" height="2732" src="<?php echo e(filePathRoot(config('laravelpwa.manifest.splash.2048x2732'))); ?>">
                                            </div>
                                        </div>
                                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/AI_writter_laravel/core/resources/views/setting/setting.blade.php ENDPATH**/ ?>