...
<head>
    ...
    <title><?php echo $__env->yieldContent('title','Home'); ?> - <?php echo e(readConfig('name')); ?></title>
    ...
    <?php if(readConfig('pwa_active') == 'yes'): ?>
...
<body>
    ...
    <aside class="sidebar">
        ...
        <div class="sidebar-body">
            ...
            <ul class="sidebar-menu">
                ...
                <li>
                    <a href="<?php echo e(route('home')); ?>" class="sidebar-menu-link">
                        <img src="<?php echo e(asset('assets/icons/home.svg')); ?>" alt="home icon ">
                        <span class="text">Dashboard</span>
                    </a>
                </li>
                <li>
                    <a href="#" class="sidebar-menu-link" data-bs-toggle="collapse" data-bs-target="#aiContent">
                        <img src="<?php echo e(asset('assets/icons/content.svg')); ?>" alt="user icon ">
                    ...
                    <div class="collapse" id="aiContent">
                        <div class="sidebar-drop">
                            <ul>
                                <li><a href="<?php echo e(route('content.create')); ?>">Content Generate</a></li>
                                <li><a href="<?php echo e(route('contents.index')); ?>">Saved Content</a></li>
                                <li><a href="<?php echo e(route('content-history.index')); ?>">Content History</a></li>
                            </ul>
                        </div>
                    </div>
                </li>
                <li>
                    <a href="#" class="sidebar-menu-link" data-bs-toggle="collapse" data-bs-target="#generateDropdown">
                        <img src="<?php echo e(asset('assets/icons/image.svg')); ?>" alt="user icon ">
                    ...
                    <div class="collapse" id="generateDropdown">
                        <div class="sidebar-drop">
                            <ul>
                                <li><a href="<?php echo e(route('image.create')); ?>">New Image</a></li>
                                <li><a href="<?php echo e(route('image.variation')); ?>">Image Variation</a></li>
                                <li><a href="<?php echo e(route('image.all')); ?>">All Images</a></li>
                            </ul>
                        </div>
                    </div>
                </li>
                ...
                <li>
                    <a href="<?php echo e(route('plan.userIndex')); ?>" class="sidebar-menu-link">
                        <img src="<?php echo e(asset('assets/icons/credit-card.svg')); ?>" alt="credit card  icon ">
                ...
                <li>
                    <a href="#" class="sidebar-menu-link">
                        <img src="<?php echo e(asset('assets/icons/reports.svg')); ?>" alt="credit card  icon ">
                ...
                <li>
                    <a href="<?php echo e(route('dashboard')); ?>" class="sidebar-menu-link">
                        <img src="<?php echo e(asset('assets/icons/home.svg')); ?>" alt="home icon ">
                ...
                <li>
                    ...
                    <div class="collapse" id="aiManage">
                        <div class="sidebar-drop">
                            <ul>
                                <li><a href="<?php echo e(route('use-case.index')); ?>">Use Case Templates</a></li>
                                <li><a href="<?php echo e(route('setting')); ?>?tab=openai">AI Settings</a></li>
                            </ul>
                        </div>
                    </div>
                </li>
                <li>
                    ...
                    <div class="collapse" id="userManagement">
                        <div class="sidebar-drop">
                            <ul>
                                <li><a href="<?php echo e(route('users.index')); ?>">Customer List</a></li>
                                <li><a href="<?php echo e(route('admin.all')); ?>">Admin List</a></li>
                            </ul>
                        </div>
                    </div>
                </li>
                <li>
                    ...
                    <div class="collapse" id="financialManagement">
                        <div class="sidebar-drop">
                            <ul>
                                <li><a href="<?php echo e(route('plan.index')); ?>">Manage Plan</a></li>
                                <li><a href="<?php echo e(route('payment.method')); ?>">Payment Methods</a></li>
                                <li><a href="<?php echo e(route('order.index')); ?>">All Transections</a></li>
                                <li><a href="<?php echo e(route('order.index')); ?>?status=0">Pending Transections</a></li>
                            </ul>
                        </div>
                    </div>
                </li>
                <li>
                    ...
                    <div class="collapse" id="frontendManage">
                        <div class="sidebar-drop">
                            <ul>
                                <li><a href="<?php echo e(route('setting')); ?>?tab=cms">Frontend Settings</a></li>
                                <li><a href="<?php echo e(route('manage-blogs.index')); ?>">Blog Manager</a></li>
                                <li><a href="<?php echo e(route('blog-category.index')); ?>">Blog Category</a></li>
                                <li><a href="<?php echo e(route('manage-faq.index')); ?>">FAQ Manager</a></li>
                                <li><a href="<?php echo e(route('pages.index')); ?>">Page Builder</a></li>
                            </ul>
                        </div>
                    </div>
                </li>
            ...
            <ul class="sidebar-menu d-none">
                <li>
                    <a href="<?php echo e(route('content.create')); ?>" class="add-btn" data-bs-toggle="tooltip"
                        data-bs-placement="right" data-bs-title="Generate your Content">+</a>
                </li>
                <li>
                    <a href="<?php echo e(route('image.create')); ?>" class="add-btn" data-bs-toggle="tooltip"
                        data-bs-placement="right" data-bs-title="AI Image Generate">-</a>
                </li>
                <?php if(Auth::user()->type == 'user'): ?>
                <li>
                    <a href="<?php echo e(route('home')); ?>" class="sidebar-menu-link" data-bs-toggle="tooltip"
                        data-bs-placement="right" data-bs-title="Home">
                        <img src="<?php echo e(asset('assets/icons/home.svg')); ?>">
                    </a>
                </li>
                <?php endif; ?>
                <li>
                    <a href="<?php echo e(route('contents.index')); ?>" class="sidebar-menu-link" data-bs-toggle="tooltip"
                        data-bs-placement="right" data-bs-title="Saved Content">
                        <img src="<?php echo e(asset('assets/icons/save.svg')); ?>">
                    </a>
                </li>
                <li>
                    <a href="<?php echo e(route('content-history.index')); ?>" class="sidebar-menu-link" data-bs-toggle="tooltip"
                        data-bs-placement="right" data-bs-title="Genertated History">
                        <img src="<?php echo e(asset('assets/icons/cards-icons/Book.svg')); ?>">
                    </a>
                </li>

                <li>
                    <a href="<?php echo e(route('plan.userIndex')); ?>" class="sidebar-menu-link" data-bs-toggle="tooltip"
                        data-bs-placement="right" data-bs-title="Purchase Plan"> <img
                            src="<?php echo e(asset('assets/icons/layers.svg')); ?>"> </a>
                </li>
                ...
                <?php if(Auth::user()->type == 'admin'): ?>
                    ...
                    <li>
                        <a href="<?php echo e(route('users.index')); ?>" class="sidebar-menu-link" data-bs-toggle="tooltip"
                            data-bs-placement="right" data-bs-title="User Management"> <img
                                src="<?php echo e(asset('assets/icons/users.svg')); ?>"> </a>
                    </li>

                    <li>
                        <a href="<?php echo e(route('plan.index')); ?>" class="sidebar-menu-link" data-bs-toggle="tooltip"
                            data-bs-placement="right" data-bs-title="Manage Plan"> <img
                                src="<?php echo e(asset('assets/icons/zap.svg')); ?>"> </a>
                    </li>
                    ...
                    <li>
                        <a href="<?php echo e(route('order.index')); ?>" class="sidebar-menu-link" data-bs-toggle="tooltip"
                            data-bs-placement="right" data-bs-title="Orders"> <img
                                src="<?php echo e(asset('assets/icons/layers.svg')); ?>"> </a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('payment.method')); ?>" class="sidebar-menu-link" data-bs-toggle="tooltip"
                            data-bs-placement="right" data-bs-title="Payment Gateway"> <img
                                src="<?php echo e(asset('assets/icons/credit-card.svg')); ?>"> </a>
                    </li>

                    <li>
                        <a href="<?php echo e(route('setting')); ?>" class="sidebar-menu-link" data-bs-toggle="tooltip"
                            data-bs-placement="right" data-bs-title="System Settings"> <img
                                src="<?php echo e(asset('assets/icons/gear.svg')); ?>"> </a>
                    </li>
                <?php endif; ?>
    ...
    <main class="mainsection">
        ...
        <header class="header">
            ...
            <button class="btn d-lg-none" data-bs-toggle="offcanvas" data-bs-target="#mobileMenu"><img
                    src="<?php echo e(asset('assets/icons/menu.svg')); ?>" alt=""></button>
            <!-- MOBILE-LOGO -->
            <h3 class="logo-name d-lg-none "><?php echo e(readConfig('type_name')); ?></h3>
            <!-- ICON-MENU START -->
                    ...
                    <li class="headermenu-item">
                        <div class="user-info">
                            <figure class="user-thumb">
                                <img src="<?php echo e(filePath(Auth::user()->avatar)); ?>" alt="user image ">
                            </figure>
                        ...
                        <div class="userdropdown">
                            ...
                            <ul class="userlist">
                                <li class="userlist-item">
                                    <a href="<?php echo e(route('profile')); ?>" class="userlist-link">My Profile</a>
                                </li>
                                <li class="userlist-item">
                                    <a href="<?php echo e(route('profile.password')); ?>" class="userlist-link">Change Password</a>
                                </li>
                                <li class="userlist-item">
                                    <a class="userlist-link" href="<?php echo e(route('logout')); ?>"
    ...
    <!--NICE SELECT 2  JS-->
    <script src="<?php echo e(asset('assets/js/niceselect2/nice-select2.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/niceselect2/nice-select-2-bind.js')); ?>"></script>
    ...
    <?php echo $__env->make('layouts.delete', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>;
    <?php echo $__env->yieldContent('script'); ?>
    <?php echo $__env->make('layouts.modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>;
    <!--Start of Tawk.to Script-->
    <?php if(readConfig('tawk_to') == 'yes'): ?>
        <?php echo $__env->make('layouts.tawk_to', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>;
    <?php endif; ?>
    <!--End of Tawk.to Script-->

</body>
<?php /**PATH /opt/lampp/htdocs/AI_writter_laravel/core/resources/views/layouts/app.blade.php ENDPATH**/ ?>