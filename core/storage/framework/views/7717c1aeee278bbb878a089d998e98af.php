...
<head>
    ...
    <title><?php echo e(readConfig('name')); ?> </title>
            ...
            <div class="header-desk d-none d-lg-flex ">
                <div class="header-left">
                    <a href="<?php echo e(route('/')); ?>">
                        <h3 class="logo-name text-center header-logo"><?php echo e(readConfig('name')); ?> </h3>
                    </a>
                    <ul class="desk-menu">
                        <li>
                            <a href="<?php echo e(route('/')); ?>#usecase" class="desk-menu-link">Use Cases</a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('/')); ?>#generateImage" class="desk-menu-link">Image generator </a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('/')); ?>#works" class="desk-menu-link">How it Works </a>
                        </li>

                        <li>
                            <a href="<?php echo e(route('/')); ?>#pricing" class="desk-menu-link">Pricing</a>
                        </li>
                        <li><a href="<?php echo e(route('blogs.index')); ?>" class="desk-menu-link">Blog</a></li>
                    </ul>
                </div>
                ...
                <div class="header-right">
                    <ul class="desk-menu">
                        ...
                        <li><a href="<?php echo e(route('login')); ?>" class="primarybtn-landing ">Get started ___ it’s free</a></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="row g-4 text-center px-5 justify-content-center" data-aos="fade-up" data-aos-duration="1000">
                ...
                <div class="col-lg-4">
                    <div class="getstarted-box">
                        <div class="long-check-wrapper">
                            <img src="<?php echo e(asset('assets/icons/cards-icons/check-logn.svg')); ?>" alt="long check icon ">
                        </div>
                ...
                <div class="col-lg-4">
                    <div class="getstarted-box">
                        ...
                        <span><?php echo e(totalUseCase()); ?>+ content types to explore</span>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="getstarted-box">
        ...
        <div class="container">
            <div class="footer-content" data-aos="fade-up" data-aos-duration="1000">
                <div class="row g-4">
                    <div class="col-lg-2">
                        <a href="index.html">
                            <h3 class="logo-name "><?php echo e(readConfig('name')); ?> </h3>
                        </a>
                    </div>
                ...
                <div class="footer-social">
                    <ul class="socilmenu">
                        <li class="socialmenu-item">
                            <a href="" class="socialmenu-link"><img src="<?php echo e(asset('assets/icons/social/facebook.svg')); ?>"
                                    alt=""></a>
                        </li>
                        <li class="socialmenu-item">
                            <a href="" class="socialmenu-link"><img src="<?php echo e(asset('assets/icons/social/twitter.svg')); ?>"
                                    alt=""></a>
                        </li>
                        <li class="socialmenu-item">
                            <a href="" class="socialmenu-link"><img src="<?php echo e(asset('assets/icons/social/linkdin.svg')); ?>"
                                    alt=""></a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="copyright">
                    <p class="copyright-text">© <?php echo e(date('Y')); ?> <?php echo e(readConfig('name')); ?>  </p>
                </div>
            </div>
        </div>
    </footer>
    ...
    <div class="offcanvas offcanvas-start" tabindex="-1" id="mobileMenu" aria-labelledby="mobileMenu">
        ...
        <div class="offcanvas-body">
            <ul class="mobilelist">
                ...
                <li class="mobilelist-item" data-bs-dismiss="offcanvas">
                    <a href="<?php echo e(route('login')); ?>" class="mobilelist-link">Login</a>
                </li>
...
<?php /**PATH /opt/lampp/htdocs/AI_writter_laravel/core/resources/views/frontend/app.blade.php ENDPATH**/ ?>