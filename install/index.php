...
function makeAPICall($purchase_code, $url)
{
	// Create an array with the required data for the API call
	$requestData = array(
	...
	$apiUrl = 'https://qtecsolution.net/api/verify/purchase'; // Replace with your actual API endpoint URL
	...
	if ($httpCode === 200 || $httpCode === 400) {
		// Process the API response and return true or false based on the result
								...
								<div class="success-area text-center">
									...
									if ($_POST) {
										...
										if ($apiResponse['status'] === 200) {
											...
											echo '<h2 class="text-danger text-uppercase mb-5">Your system has not been installed properly!</h2>';

											echo '<p class="text-warning warning">' .
												$apiResponse['errors']['purchase_code'] . '</p>';
							...
							<div class="box-item">
								<form action="?action=complete" method="post" class="information-form-area mb--20">
									<div class="info-item">
										...
										<div class="row">
											<div class="information-form-group col-md-4">
											...
											<div class="information-form-group col-md-4">
												<input type="text" name="purchase_code" placeholder="Enter Purchase Code" required>
											</div>
										</div>
									</div>
									...
									<div class="info-item">
										...
										<div class="row">
											<div class="information-form-group col-lg-4 col-sm-6">
												<label class="form-label">Username</label>
												<input name="admin_user" type="text" placeholder="Admin Username" required>
											</div>
											<div class="information-form-group col-lg-4">
